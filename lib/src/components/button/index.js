...
class KButton extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(theme_1.ThemeBox, { themeStyles: style_1.default, styles: styles }, _styles => this.renderButton(_styles)));
    }
}
